        ...
        <div className="min-h-screen bg-white dark:bg-[#0d1117] flex flex-col">
            ...
            <main className="flex-1 flex flex-col items-center justify-center p-6 text-center max-w-6xl mx-auto w-full">
                ...
                <div className="mb-16 animate-in fade-in slide-in-from-bottom-4 duration-700">
                    <h2 className="text-[#A61933] font-bold uppercase tracking-[0.2em] text-sm mb-4">Bienvenido al Ecosistema Digital</h2>
                    <h1 className="text-5xl md:text-7xl font-black text-[#111418] dark:text-white tracking-tighter mb-6 leading-tight">
                        ...
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#A61933] to-[#C594C5]">Promociones Inmobiliarias</span>
                    </h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl">
                    ...
                    <Link
                        to="/promociones"
                        className="group relative bg-white dark:bg-[#1a2632] border border-gray-200 dark:border-[#2a3846] p-8 rounded-3xl shadow-xl hover:shadow-2xl hover:border-[#A61933]/30 transition-all duration-500 overflow-hidden text-left"
                    >
                        <div className="absolute top-0 right-0 w-32 h-32 bg-gray-50 dark:bg-[#23303d] rounded-bl-[100px] transition-colors group-hover:bg-[#A61933]/5 -z-0"></div>

                        <div className="relative z-10">
                            <div className="size-16 bg-[#A61933] text-white rounded-2xl flex items-center justify-center mb-6 shadow-lg shadow-[#A61933]/20 group-hover:scale-110 transition-transform duration-500">
                                <span className="material-symbols-outlined text-3xl">apartment</span>
                            </div>
                            <h3 className="text-2xl font-black text-[#111418] dark:text-white mb-3">Gestión de Promociones</h3>
                            <p className="text-gray-500 dark:text-gray-400 mb-8 leading-relaxed">
                                Visualización técnica, análisis de entorno con IA y seguimiento detallado del histórico de promociones del grupo.
                            </p>
                            <div className="flex items-center gap-2 text-[#A61933] font-bold">
                    ...
                    <div className="group relative bg-gray-50/50 dark:bg-[#121b24] border border-gray-200 dark:border-[#2a3846] p-8 rounded-3xl transition-all duration-500 text-left grayscale hover:grayscale-0 opacity-80 hover:opacity-100 cursor-not-allowed">
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-gray-500 dark:text-gray-400 mb-8 leading-relaxed">
                                Estandarización de procesos, normativas y guías de calidad para el desarrollo de nuevas promociones de SALAS.
                            </p>
